...
### Сборка проекта
Перед сборкой проекта необходимо изменить значения переменных URL, USER, PASSWD на актуальные в файле src/main/java/ru/example/App.java. По умолчанию значения равны:
````
URL = "jdbc:postgresql://localhost:5432/vikula";
USER = "vikula";
PASSWD = "111";
````
**Сборка:**
